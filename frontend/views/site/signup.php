...
<div class="wrapper">
		...
		<div class="sign-in-page">
			<div class="zsignin-popup col-xs-10 col-xs-offset-1  col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 top_bbl">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  no-pdd">
													<!--<button type="submit" value="submit" id="submit">Get Started</button>-->
                                                     <?= Html::submitButton( 'Get Started', ['class' => 'btn btn-primary' , 'id'=>'btnsignup']) ?>
												</div>
											</div>
                                            <?php ActiveForm::end(); ?>
										<!--</form>-->
