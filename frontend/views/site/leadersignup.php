...
$('#signupForm input').on('change', function() {
	...
	//echo Html::hiddenInput('uniqueCode', $uniqueCode);
?>
						...
						<div class="col-lg-12 zcol-lg-offset-3">
                            ...
                            <ul class="anch_sign-control ledr_btn">
								...
								<div class="sign_in_sec" id="tab-1">
									<h2 class="con_tele_hdr">Join Jijigram today.</h2>
									<h3>Sign in</h3>
									<form>
										<div class="row">
                                ...
                                <h2 class="ledr_dtls">Join Jijigram today.</h2>
...
-->													</div>
                                                ...
                                                <div class="col-lg-12 no-pdd">
													<div class="sn-field">
													<p class="em_fnt">	<?= $form->field($leaderinvite, 'code')->textInput(['maxlength' => true,'placeholder' => "Give Your Code Here", 'required' => true])->label(false); ?> </p>
														<!--<i class="fa fa-at"></i>-->
														<!--<span><i class="fa fa-ellipsis-h"></i></span>-->
													</div>
												</div>
												...
												<div class="col-lg-12 no-pdd">
													<div class="checky-sec st2">
														<div class="fgt-sec">
															...
															<small>Yes, I understand and agree to the Jijigram  Terms &amp; Conditions.
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
												...
												<div class="col-lg-12 no-pdd">
                                                    ...
                                                    <?= Html::submitButton( 'Get Started', ['class' => 'btn btn-primary' , 'value'=>'Create']) ?>
												</div>
											</div>
                                            <?php ActiveForm::end(); ?>
										<!--</form>-->
...
<script>  
 $(document).ready(function(){  alert();
      $('#leaderinvite-code').keyup(function(){
		  alert();
		  });  
